        ...
        <header className="mb-8 border-b border-cyan-500/30 pb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-cyan-400 uppercase tracking-wider">Live Feed</h1>
                <p className="text-gray-500 text-sm">Real-time Surveillance Monitoring</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-6">
            <div className="bg-black/40 border border-cyan-500/30 rounded-lg p-6 backdrop-blur-sm">
              <h2 className="text-cyan-400 uppercase tracking-wider mb-4">Camera Feed</h2>
