...
export function Auth() {
  ...
  const [status, setStatus] = useState<
    "idle" | "scanning" | "analyzing" | "success" | "denied"
  >("idle");
      ...
      <div className="relative z-10 w-full max-w-2xl px-6">
        <div className="bg-black/60 border border-cyan-500/30 rounded-lg p-8 backdrop-blur-sm">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-cyan-400 uppercase tracking-wider text-2xl mb-2">
              Project Argus
            </h1>
          ...
          <div className="relative mb-6">
            {cameraError ? (
              <div className="bg-black/60 border-2 border-yellow-500/50 rounded-lg p-12 text-center">
                ...
                <h3 className="text-yellow-400 uppercase tracking-wider mb-2">
                  Camera Access Required
                </h3>
                <p className="text-gray-400 text-sm mb-4">
                  Please allow camera access in your browser to use facial
                  recognition.
                </p>
                <button
                  onClick={startCamera}
                ...
                {status === "success" && (
                  <div className="absolute inset-0 bg-green-500/20 border-4 border-green-500 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-green-400 uppercase tracking-wider">
                        Access Granted
                      </p>
                    </div>
                  </div>
                ...
                {status === "denied" && (
                  <div className="absolute inset-0 bg-red-500/20 border-4 border-red-500 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-red-400 uppercase tracking-wider">
                        Access Denied
                      </p>
                    </div>
                  </div>
